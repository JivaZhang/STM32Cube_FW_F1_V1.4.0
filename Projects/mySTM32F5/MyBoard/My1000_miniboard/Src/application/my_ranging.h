...
//#define USE_ORI_ANTENNA_DELAY
	
//	#define DEBUG_ENABLE        //either   Debug or BLEUART would be defined
	#define TAG_BLEUART_OUTPUT    (1)
#if TAG_BLEUART_OUTPUT==1
#define OUTPUT_SPI_OR_UART    (1)  // UART=1 SPI=0	
#endif
	
	
#define CORRECT_RANGE_BY_RANGE

#ifndef  CORRECT_RANGE_BY_RANGE     //CORRECT_RANGE_BY_RANGE is the most accurate in experience  By RePWR only in theory
	#define USE_MEASURED_RANGE_BIAS    //use measured bias and antenna delay fix for tag A
	#define CORRECT_TIME_BY_RePWR (1)     // Compensate for small bias due to uneven accumulator growth at close up high power
#endif
...
#define BLINK_SLEEP_DELAY					330 //ms
#define POLL_SLEEP_DELAY					200 //ms
#define CHECK_DEV_INTERVAL        500 //ms
#define DEVICE_TIMEOUT_PERIOD     2000   //remove a dvice if  it did not response in 2S


#ifndef FREQBAND_110K
	//in us
	#define DEFAULT_REPLY_DELAY_TIME 2000    //for preamble 1024  in us    //this is the interval between 2 anchor response
//	#define MINUM_POLLACK_DELAY  0
	#define DEFAULT_RANGE_DELAY  350  //us       350us for 6.8M            //for range to savely send
	#define MINUM_FINAL_DELAY         800   //us
#else
	//in us
	#define DEFAULT_REPLY_DELAY_TIME 10000     //for preamble 1024  in us
//	#define MINUM_POLLACK_DELAY  650
	#define DEFAULT_RANGE_DELAY  7000  //us       350us for 6.8M
	#define MINUM_FINAL_DELAY         800   //us
#endif
...
static const uint8  BIAS_SELF_MEASURED[]={172,     65,    13,     11,      11,      20,       21,      22,      23,       24,       25,     28,       47      };      
  #define       BIAS_SELF_MEASURED_ZERO   3
	//  {68,    70,     72,     74,     76,     78,     80       82       84        86        88,     90,     92}  
  //	{-0.172	-0.065	-0.013	0.011	  0.011	  0.020	  0.021    0.022    0.023     0.024     0.025	  0.028	  0.047}
