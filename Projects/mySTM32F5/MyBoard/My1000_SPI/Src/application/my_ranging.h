...
#define BLINK_SLEEP_DELAY					500 //ms
#define POLL_SLEEP_DELAY					80 //ms
#define CHECK_DEV_INTERVAL        500 //ms
#define DEVICE_TIMEOUT_PERIOD     2000   //remove a dvice if  it did not response in 2S

//in us
#define DEFAULT_REPLY_DELAY_TIME 200     //for preamble 1024  in us
#define DEFAULT_RANGE_DELAY  400  //us
