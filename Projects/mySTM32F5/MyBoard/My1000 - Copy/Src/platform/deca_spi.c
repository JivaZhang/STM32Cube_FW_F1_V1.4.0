				...
				uint8 *readBuffer)
{
	...
	HAL_SPI_TransmitReceive(&hspi1, (uint8_t *)headerBuffer, (uint8_t *)spi_TmpBuffer, (uint16_t)(headerLength+readlength), (uint32_t)10);
...
(
	...
	HAL_UART_Transmit(&huart1,(uint8_t*)bodyBuffer,bodylength,10);
}
#endif
